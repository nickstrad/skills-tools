...
[postgres-essentials.md](postgres-essentials.md): 40 planned lessons, first 21 available.
...
| [postgres-lab.md](postgres-lab.md)                                             | Learner versus author cluster paths, lesson-9 readiness and resource lifecycle.                                                                                            |
