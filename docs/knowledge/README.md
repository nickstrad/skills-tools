...
| [postgres-durable-protocol-evidence.md](postgres-durable-protocol-evidence.md) | Actual outbox commits, idempotency snapshot races, process loss, identity retention and deduplicated business effects. |
