...
| [postgres-incident-evidence.md](postgres-incident-evidence.md)                 | Staged diagnosis, bounded receiver acknowledgement, corruption scope, verified restore boundaries and fixture cleanup.                                                |
