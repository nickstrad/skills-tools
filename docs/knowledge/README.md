...
| [postgres-durable-protocol-evidence.md](postgres-durable-protocol-evidence.md) | Actual outbox receiver commits, process loss, durable claim generations and deduplicated business effects. |
