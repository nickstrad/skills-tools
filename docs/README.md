...
Follow [`knowledge/vm-resource-cleanup.md`](knowledge/vm-resource-cleanup.md). Revalidate disk
usage, memory and live processes before allocating or deleting resources. Stop and clean owned labs
