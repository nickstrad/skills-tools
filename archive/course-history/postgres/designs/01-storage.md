...
legacy metadata resources to cache and rewrite rationale without numeric lesson refs. Remove
...
Report retired slug/metadata transfer and preserved first7 check. No commits. Ask primary if an
