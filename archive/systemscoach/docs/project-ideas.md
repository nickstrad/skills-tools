...
The standalone [systems project ranking](project-ranking.md) orders all 15 examples by expected
learning value for Nick, with the main teaching focus and a two-sentence rationale for each.
It also explains the ranking criteria and recommended starting projects.
