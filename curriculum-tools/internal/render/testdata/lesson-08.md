# Lesson 8: Two valid decisions can break one shared rule

**Meta:** concurrency-control | intermediate | ~25 min | run in psql, 2 psql sessions | ddl  
**Topics:** isolation, repeatable-read, concurrency-control  
Lesson ID: 8
