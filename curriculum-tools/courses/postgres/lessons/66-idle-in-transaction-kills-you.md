# Verify what a deadline cancels, rolls back and disconnects

slug: idle-in-transaction-kills-you
category: observability
difficulty: intermediate
tags: timeouts, connections, observability, gc-horizon
prerequisites: wait-events-tell-you-where-time-goes, lock-timeout-and-nowait, install-lab-extensions
safety: locking
run-in: shell
sessions: 1
min-version: 16
