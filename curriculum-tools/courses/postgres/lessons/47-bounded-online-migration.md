# Backfill in short transactions and prove the migration is complete

slug: bounded-online-migration
category: indexes
difficulty: advanced
tags: migrations, ddl, skip-locked, constraints
prerequisites: create-index-concurrently-and-invalid-indexes, skip-locked-work-queue, ddl-behind-a-long-query
safety: ddl
run-in: tool
sessions: 2
min-version: 16
