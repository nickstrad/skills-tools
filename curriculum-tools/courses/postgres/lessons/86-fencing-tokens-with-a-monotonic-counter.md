# Fencing tokens: enforce the resource boundary and its commit order
...
prerequisites: advisory-locks-as-leases, optimistic-concurrency-with-version-columns, idempotency-keys
safety: privileged
run-in: shell
sessions: 3
min-version: 16
