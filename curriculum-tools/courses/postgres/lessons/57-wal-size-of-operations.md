# WAL cost per verified row: ingestion, indexes and avoided writes

slug: wal-size-of-operations
category: wal
difficulty: advanced
tags: wal, write-amplification, hot-updates, capacity
prerequisites: every-change-is-a-wal-record, hot-updates-and-fillfactor, commit-means-fsync
safety: privileged
run-in: shell
sessions: 1
min-version: 16
