# Incident: recover a failed read and account for accepted operations

slug: corrupt-a-page-and-detect-it
category: reliability
difficulty: advanced
tags: checksums, corruption, pages-and-tuples, incident, backup
prerequisites: table-is-a-file, visibility-map-and-index-only-scans, point-in-time-recovery
safety: dangerous
run-in: shell
sessions: 1
min-version: 16
