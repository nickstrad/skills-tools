# Measure throughput and waiting as active clients increase

slug: connection-saturation
category: observability
difficulty: advanced
tags: connections, capacity, observability, row-locks
prerequisites: wait-events-tell-you-where-time-goes, pg-stat-statements-as-tracing, row-locks-are-in-the-tuple
safety: writes-data
run-in: shell
sessions: 1
min-version: 16
