...
export const LAB: Module = {
  category: "lab-setup",
  title: "Build a disposable SQLite Systems lab",
  lessons: [
    {
      slug: "build-lab",
      title: "Build a disposable SQLite Systems lab you can break",
      difficulty: "beginner",
...
known sqlite3 version, and a way to open two sessions against the same data.`,
      syntaxBreakdown: code`
Describe each command or flag the learner meets for the first time, one sentence each.`,
      code: code`
export TUTOR_LAB=$HOME/sqlite-lab
mkdir -p "$TUTOR_LAB"
sqlite3 --version`,
      expectedResult: code`
